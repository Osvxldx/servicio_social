...
class MainApplication:
    ...
    def create_professional_header(self, parent):
        ...
        if os.path.exists(logo_path):
            try:
                ...
                pil_image = pil_image.resize((150, 100), Image.Resampling.LANCZOS)
    ...
    def show_instructions(self):
        ...
        messagebox.showinfo(
            "Instrucciones",
            "Bienvenido al Sistema de Gestión de Agua Potable.\n\n"
            "1. Utilice el menú superior o los botones grandes para navegar.\n"
    ...
    def show_about(self):
        ...
        messagebox.showinfo(
            ...
            "Desarrollado para el Comité de Agua Potable\n"
            "Barrio de San Antonio Tecamachalco, Pue.\n\n"
...
if __name__ == "__main__":
    ...
    if authenticate(root):
        root.deiconify()  # Mostrar ventana principal si el login es exitoso
        app = MainApplication(root)
        root.mainloop()
    else:
        # Si falla la autenticación o se cierra la ventana
        root.destroy()
        sys.exit()